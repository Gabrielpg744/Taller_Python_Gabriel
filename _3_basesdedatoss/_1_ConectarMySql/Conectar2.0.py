...
if __name__ == '__main__':
    ...
    if conexion.BanConexion:
        if conexion.Insertar("usuarios",("Nuevo nombre","nomUsuario", "nuevoNombre@gmail.com","123456", 41)):
        ...
        if res != None:
            for fila in res:
                print(f"ID: {fila[0]}, Nombre usuario: {fila[1]}, correo: {fila[2]}, contrasenia: {fila[3]}, id_rol: {fila[4]}")
        else:
